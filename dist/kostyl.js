...
var baseConvert = __webpack_require__(69),
...
var _flow2 = __webpack_require__(73);
...
var _isDom = __webpack_require__(24);
...
var Component = function () {
  ...
  _createClass(Component, [{
    ...
    value: function setState(newState) {
      ...
      this.state = (0, _merge3.default)(state, newState);
    }
  }, {
    key: 'bindEvent',
    value: function bindEvent(eventType, func) {
      var eventListener = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.root;

      if (eventListener == null || !(0, _isDom2.default)(eventListener)) {
    ...
    value: function unmount() {
      ...
      this.events = (0, _flow3.default)((0, _map3.default)(function (eventTuple) {
        var _eventTuple = _slicedToArray(eventTuple, 3),
            eventListener = _eventTuple[0],
            eventType = _eventTuple[1],
            func = _eventTuple[2];

        eventListener.removeEventListener(eventType, func);
        return null;
      }), (0, _filter3.default)(function (i) {
        return !i === null;
      }))(this.events);
    }
  }]);
...
var assignMergeValue = __webpack_require__(12),
    cloneBuffer = __webpack_require__(39),
...
var Uint8Array = __webpack_require__(27);
...
var LodashWrapper = __webpack_require__(25),
    flatRest = __webpack_require__(18),
    getData = __webpack_require__(47),
    getFuncName = __webpack_require__(48),
    isArray = __webpack_require__(4),
...
var createWrap = __webpack_require__(6);
...
var mapping = __webpack_require__(70),
    fallbackHolder = __webpack_require__(0);
...
module.exports = {
  ...
  'isArray': __webpack_require__(4),
  'isFunction': __webpack_require__(10),
  'iteratee': __webpack_require__(85),
  'keys': __webpack_require__(34),
  'rearg': __webpack_require__(89),
  'toInteger': __webpack_require__(90),
  'toPath': __webpack_require__(91)
};
...
var convert = __webpack_require__(3),
    func = convert('filter', __webpack_require__(67));

func.placeholder = __webpack_require__(0);
module.exports = func;
...
var convert = __webpack_require__(3),
    func = convert('flow', __webpack_require__(68));
...
var convert = __webpack_require__(3),
    func = convert('merge', __webpack_require__(88));
...
(function webpackMissingModule() { throw new Error("Cannot find module \"dist/kostyl.js\""); }());
